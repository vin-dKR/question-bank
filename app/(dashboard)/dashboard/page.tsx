...
export default function Dashboard() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* An "Active Users" tile used to sit here showing a hardcoded 0.
                A fabricated metric is worse than no metric: it reads as real and
                quietly tells the user their product is empty. Bring it back when
