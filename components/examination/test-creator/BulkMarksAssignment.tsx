                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <Input
                            ...
                            min="1"
                        />
                        <Button onClick={() => dispatch({ type: 'APPLY_BULK_MARKS', marks: bulkMarks })} size="sm" className="bg-black text-white">
                            Apply to All
                        </Button>
                    </div>
                    <div className="flex items-center gap-2">
                        <label className="text-sm font-medium">Set negative marks for all questions:</label>
                        <Input
                            className="w-20 border border-black/30"
                            type="number"
                            ...
                            min="0"
                        />
                        <Button onClick={() => dispatch({ type: 'APPLY_BULK_NEGATIVE_MARKS', negativeMarks: bulkNegativeMarks })} size="sm" className="bg-black text-white">
                            Apply to All
                        </Button>
                    </div>
                </div>
