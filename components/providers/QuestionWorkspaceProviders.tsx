 ...
 * question bank, manage folders/templates/drafts, or generate PDFs. Mount this
 * in route layouts that need it instead of the dashboard root layout, so
 * cold-start dashboards stay provider-free.
 */
